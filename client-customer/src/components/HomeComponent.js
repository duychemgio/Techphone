 ...
 const reviews = [
  {
    ...
    rating: 5,
    comment: "Vừa mới mua 1 con S23 Ultra của shop hôm qua. Máy mượt, cam đẹp, mình chụp hình hơi nhiều nên thấy ưng lắm nói chung lần sau sẽ ghé mua tiếp.",
    profileImage:profile1,
  },
  {
    customerName: "Nguyễn Trọng Hữu",
    rating: 4,
    comment: "Chất lượng phục vụ khá tốt, Giá ở đây khá rẻ so với thị trường. Tuy nhiên có một điểm trừ là chỉ có 1 chi nhánh",
    profileImage:profile3,
  },
  {
    customerName: "Bé Na",
    rating: 5,
    comment: "Giá cả phải chăng, sản phẩm đúng như mô tả.",
